...
function getImagemProfissional(nome: string): string {
    return imagensPorProfissional[nome] || "/imgs/Cabelo.png";
}
...
const Home = () => {
    ...
    const podeVoltar = indiceInicio > 0;

    const avancar = () => {
        if (podeProsseguir) setIndiceInicio((prev) => prev + 1);
    };

    const voltar = () => {
        if (podeVoltar) setIndiceInicio((prev) => prev - 1);
    };

    const profissionaisVisiveis = profissionais.slice(indiceInicio, indiceInicio + VISIVEIS);
            ...
            <main className=" d-flex align-items-center flex-column" style={{backgroundColor: "var(--preto-fundo)"}}>
                ...
                <section className="vh-100 d-flex align-items-center flex-column justify-content-around container">
                    ...
                    <svg className="position-absolute" style={{right: "-300px", rotate: "-180deg"}} width="1069"
                        ...
                        <defs>
                            <linearGradient id="myGradient" x1="0" y1="0" x2="1069" y2="771" gradientUnits="userSpaceOnUse">
                    ...
                    <svg className="position-absolute" style={{left: "-200", top: "1200px"}} width="767" height="591"
                        ...
                        <defs>
                            <linearGradient id="myGradient2" x1="0" y1="0" x2="1069" y2="771" gradientUnits="userSpaceOnUse">
                                <stop offset="0%" stopColor="#fcff9e"/>
                                <stop offset="100%" stopColor="#c67700"/>
                            </linearGradient>
                        </defs>
                ...
                <section className="text-white vh-100 col-12 container d-flex flex-column justify-content-around" id="Equipe">
                    ...
                    <div className="col-12 d-flex flex-column gap-3">
                        {loading && (
                            <p className="text-white text-center">Carregando profissionais...</p>
                        )}

                        {erro && (
                            <p className="text-danger text-center">Erro ao carregar profissionais: {erro}</p>
                        )}
                                ...
                                <div className="d-flex align-items-center justify-content-between px-1">
                                    <div className="d-flex gap-2">
                                        {profissionais.map((_, i) => (
                                            i < profissionais.length - VISIVEIS + 1 && (
                                                <span
                                                    key={i}
                                                    onClick={() => setIndiceInicio(i)}
                                                    style={{
                                                        width: "10px",
                                                        height: "10px",
                                                        borderRadius: "50%",
                                                        backgroundColor: indiceInicio === i ? "#c67700" : "#555",
                                                        cursor: "pointer",
                                    ...
                                    <div className="d-flex gap-2">
                                        <button
                                            ...
                                            className="btn"
                                            style={{
                                                background: podeVoltar ? "linear-gradient(135deg, #fcff9e, #c67700)" : "#333",
                                                border: "none",
                                                borderRadius: "50%",
                                                width: "40px",
                                                height: "40px",
                                        ...
                                        <button
                                            ...
                                            className="btn"
                                            style={{
                                                background: podeProsseguir ? "linear-gradient(135deg, #fcff9e, #c67700)" : "#333",
                                                border: "none",
                                                borderRadius: "50%",
                                                width: "40px",
                                                height: "40px",
                                                color: podeProsseguir ? "#000" : "#666",
